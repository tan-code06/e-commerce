...
TEMPLATES = [
    {
        ...
        # Project-level templates folder (in addition to each app's templates/ dir)
...
# Static files (CSS, JavaScript, Images that ship with the theme)
...
# Media files (product images uploaded / seeded into the database)
MEDIA_URL = '/media/'
